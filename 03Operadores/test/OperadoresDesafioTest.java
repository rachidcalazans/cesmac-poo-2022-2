...
public class OperadoresDesafioTest {
    ...
    @Test
    void subtracao() { Assertions.assertEquals(0, calculadora(2, 2, "-"));
    }

    @Test
    void multiplicacao() { Assertions.assertEquals(0, calculadora(0, 5, "*"));
    }

    @Test
    void potencia() { Assertions.assertEquals(0, calculadora(8, 0, "**"));
    }

    @Test
    void divisao() { Assertions.assertEquals(0, calculadora((double)7 , (double)0, "/"));
    }

    @Test
    void modulo() { Assertions.assertEquals(0, calculadora((double)10 , (double)2, "%"));}
}
