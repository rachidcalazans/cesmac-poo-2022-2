...
public class OperadoresExercicioTest {
    ...
    void exercicio01() {
        ...
        Assertions.assertEquals(5, i2 * i2 + i1);
        Assertions.assertEquals(0.5, i1 / (double)i2);
    }
    ...
    void exercicio03() {
        ...
        Assertions.assertEquals(true, i2 == 5);
        Assertions.assertEquals(true, i1 > 0);
        Assertions.assertEquals(false, i2 < 4);
        Assertions.assertEquals(false, i1 <= 2);
        Assertions.assertEquals(false, i2 >= 6);
    }
    ...
    void exercicio04() {
        ...
        Assertions.assertEquals(true, (i1 < 4) && (i2 > 4));
        Assertions.assertEquals(true, (i1 > 6) || (i2 > i1));
        Assertions.assertEquals(true, i1 == i1);
    }
